...
function AccountSection() {
  return (
    ...
    <div className="container">
            ...
            <nav className="navbar navbar-expand-lg">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent2">
                    <ul className="navbar-nav mr-auto">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#">Deposit <span className="sr-only">(current)</span></a>
                        </li>
                        <li className="nav-item">
            ...
            <div className="row">
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="single-statics">
                        ...
                        <div className="part-info">
                            <span className="number">$9,568.00</span>
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="single-statics">
                        ...
                        <div className="part-info">
                            <span className="number">$7,480.00</span>
                            <span className="text">Total Payout</span>
                        </div>
                    </div>
                </div>
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="single-statics">
                        ...
                        <div className="part-info">
                            ...
                            <span className="text">Deposits Total</span>
                        </div>
                    </div>
                </div>
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="single-statics">
                        ...
                        <div className="part-info">
                            ...
                            <span className="text">Pending Amount</span>
                        </div>
                    </div>
                </div>
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="single-statics">
                        ...
                        <div className="part-info">
                            ...
                            <span className="text">Interest Earn</span>
                        </div>
                    </div>
                </div>
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="single-statics">
                        ...
                        <div className="part-info">
                            ...
                            <span className="text">Your Total Earning</span>
                        </div>
                    </div>
                </div>
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="single-statics">
                        ...
                        <div className="part-info">
                            ...
                            <span className="text">Referral Earings</span>
                        </div>
                    </div>
                </div>
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="single-statics">
                        ...
                        <div className="part-info">
                            ...
                            <span className="text">Fund Transfer</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="row">
            <div className="col-xl-3 col-lg-4 benmathew-col">
                <div className="user-benmathew">
                    <h3 className="title">
                        Benmathew
                    </h3>
                    <div className="single-data">
                        <span className="title">Registration Date</span>
                        <span className="data">Sep-10-2014 11:20:37</span>
                    </div>
                    <div className="single-data">
                        <span className="title">Last Login</span>
                        <span className="data">Jul-05-2019 07:06:36</span>
                    </div>
                    <div className="single-data">
                        <span className="title">Current Login</span>
                        <span className="data">Jul-06-2019 02:47:23</span>
                    </div>
                    <div className="single-data">
                        <span className="title">Last Access IP</span>
                        <span className="data">27.57.18.1</span>
                    </div>
                    <div className="single-data">
                        <span className="title">Current Access IP</span>
                        <span className="data">122.175.131.51</span>
                    </div>
                </div>
            </div>
            <div className="col-xl-9 col-lg-8 chart-col">
                <div className="transaction-chart">
                    <h3 className="title">
                        Transaction & Deposit
                    </h3>
                    <div className="charts-for-misco">
            ...
            <div className="col-xl-12 col-lg-12">
                <div className="transactions-table">
                    <div className="table-responsive">
                        <table id="example" className="display misco-data-table width-100" >
                            <thead>
                                <tr>
                                    <th>BetID</th>
                                    <th>Game</th>
